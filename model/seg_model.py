...
class ResNetMulti(nn.Module):
    def __init__(self, block, layers, num_classes):
        ...
        # self.layer7 = self._make_pred_layer(Classifier_Module, 512, [6, 12, 18, 24], [6, 12, 18, 24], num_classes)
        # self.layer8 = self._make_pred_layer(Classifier_Module, 256, [6, 12, 18, 24], [6, 12, 18, 24], num_classes)
